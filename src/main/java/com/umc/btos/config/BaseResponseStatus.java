...
public enum BaseResponseStatus {
    ...
    ALARM_MODIFY_FAIL_STATUS(false, 6019, "Alarm.status = 'checked' 변환에 실패하였습니다."),
    INVALID_USER_ABOUT_ALARM(false, 6020, " 해당 알림에 접근 권한이 없는 회원입니다."),
    INACTVIE_ALARM(false, 6021, " 이미 확인된 알림입니다."),
