...
public class Constant {
    ...
    public static final String SYSTEM_MAIL_MAIN = "\n\n이곳에서는 오늘 일어난 일어난 지극히 일상적인, 혹은 특별할지도 모르는 일들을 다른 사람들과 공유할 수 있어요.\n" +
            ...
            "굳이 일기가 아니어도 돼요! 어딘가에 털어놓고 싶은 말이 있다면, 언제든지 우편함 아래에 있는 버튼을 눌러서 저편너머에 있는 누군가에게 편지를 보내보세요. 때로는 모르는 사람에게서 얻는 위로가 큰 힘이 되기도 한답니다.\n" +
            "알로카시아 씨앗은 잘 심으셨나요? 매일 일기를 써서 시들지 않게 잘 관리해 주세요. 이미 지나버린 과거는 오늘의 알로카시아에게 아무런 힘을 주지 못합니다. 오늘 작성한 일기만이 효력을 발휘한다는 점 꼭 기억해주세요!!\n" +
            "\n" +
            "- 저편너머에서 온 편지 -\n";
