...
public class GetHistoryRes_Main {
    ...
    // type = diary
    public GetHistoryRes_Main(String type, int typeIdx, String content, int emotionIdx, String senderNickName, String sendAt) {
        this.type = type;
    ...
    public GetHistoryRes_Main(String type, int typeIdx, String content, String senderNickName, String sendAt) {
        this.type = type;
        this.typeIdx = typeIdx;
        this.content = content;
        this.senderNickName = senderNickName;
